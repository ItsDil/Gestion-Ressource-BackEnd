...
public interface ImprimanteService {
    ...
    List<Imprimante> getImprimantesByMembreDepartement(Integer id);
    List<Imprimante> getImprimantesByDepartementName(String name);
    List<Imprimante> getImprimantesByFournisseur(Integer id);
