...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .permitAll()
                .requestMatchers("/api/v1/Canal-Controller/**")
                .permitAll()
                ...
                .hasAnyAuthority("RESP", "FOUR")
                .requestMatchers("/api/v1/Panne-Controller/**")
                .hasAnyAuthority("ENSE", "TECH","RESP")
                .requestMatchers("/api/v1/Offre-Controller/**")
                .hasAnyAuthority("RESP", "FOUR")
                .anyRequest()
                .authenticated()
                .and()
